...
public class RayTraceTest {
    ...
    public RayTraceTest(Player _player, int _res, double _rayRes, Display display, int mapChoice){
        player = _player;
        res = _res;
        rayRes = _rayRes;
    ...
    private double[] findRays(){
        ...
        for(int i = 0; i < res; i++){
            double rayAngle = (Math.toRadians(player.getAng()) - FOV / (display.getWidth() * /*.0038*/ .0011 /*ofr my monitor*/) + ((double) i / (double) res) * FOV);
